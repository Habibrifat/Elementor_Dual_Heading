...
final class Plugin {
    ...
    public function admin_notice_missing_main_plugin() {
        ...
        /* translators: 1: Plugin name 2: Elementor */
            ...
            '<strong>' . esc_html__( 'Elementor Dual Heading', 'elementor-test-addon' ) . '</strong>',
...
//        add_action( "elementor/frontend/after_enqueue_scripts", [ $this, 'frontend_assets_scripts' ] );
    ...
    public function register_widgets( $widgets_manager ) {
        ...
        require_once( __DIR__ . '/widgets/Elementor_Dual_Heading_widget.php' );

        $widgets_manager->register( new Elementor_Dual_Heading_widget() );
